...
const app = express()
app.get('/', (req, res) => res.send("Bot Aktif | Discord = htfff"))
...
/*client.on('ready', () => {
  setInterval(function() {
     ...
     if(knl){
knl.send("**Kayıt olmak için** ``z!kayıtol <isim> <yaş> `` **şeklinde doldurunuz.**")
     }
...
client.on('message', msg => {
  if (msg.content === '<@!789444783184805900>') {
    msg.channel.send(`<@!${msg.author.id}> **Prefix(Ön ekim) burada** ${ayarlar.prefix}`)
  }
})
